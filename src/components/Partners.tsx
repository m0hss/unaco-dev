    ...
    <>
      <Container>
        ...
        <div className=" py-8 mt-8 relative overflow-hidden">
          ...
          {/* Second motion container with a slight delay */}
          <motion.div
            className="flex absolute top-0 left-0"
            animate={{
              x: ["0%", "-100%"],
            ...
            transition={{
              repeat: Infinity,
              duration: 40, // Same duration for both containers
              ease: "linear",
              // delay: 5, // Delay to ensure continuous scrolling
            }}
            style={{ whiteSpace: "nowrap" }} // Prevent wrapping
          >
            {[...logos, ...logos].map((logo, index) => (
